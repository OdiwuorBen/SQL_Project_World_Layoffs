...
--Company with Mmaximum total_laid_off and percentage_laid_off
SELECT 
    MAX(total_laid_off),
...
--Companies and SUM of total_laid_off
SELECT 
    company, 
    SUM(total_laid_off)
FROM 
...
--Sum of total layoffs grouped by stage
SELECT 
    stage, 
    SUM(total_laid_off)
FROM 
...
--Number laid off from a company within one year.
SELECT 
    company, 
    SUM(total_laid_off)
FROM 
